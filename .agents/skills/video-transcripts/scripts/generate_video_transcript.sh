...
download_input_if_needed() {
  ...
  if [[ "$source" =~ ^https?:// ]]; then
    ...
    if [[ "$source" == *"github.com/user-attachments/"* || "$source" == *"private-user-images.githubusercontent.com"* || "$source" == *"private-attachments.githubusercontent.com"* || "$source" == *"media.githubusercontent.com/media/attachments/"* ]]; then
      local auth_header
