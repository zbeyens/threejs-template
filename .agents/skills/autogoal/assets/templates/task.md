...
- TODO: Name tests, typecheck, lint, browser proof, source audit, GitHub/PR sync, or other artifact proving the threshold.
...
- Create PRs or external comments only when requested or required.
...
- [ ] For GitHub bug reports, behavior claims, technical diagnoses, or
